...
import (
	...
	"github.com/OldBigBuddha/gqlgen/internal/code"
)
...
func TestSlicePointerBinding(t *testing.T) {
	t.Run("without OmitSliceElementPointers", func(t *testing.T) {
		...
		require.Equal(t, "[]*github.com/OldBigBuddha/gqlgen/codegen/config/testdata/autobinding/chat.Message", ta.GO.String())
	})
...
func TestOmittableBinding(t *testing.T) {
	t.Run("bind nullable string with Omittable[string]", func(t *testing.T) {
		...
		ot, err := binder.FindType("github.com/OldBigBuddha/gqlgen/graphql", "Omittable")
		require.NoError(t, err)
	...
	t.Run("bind nullable object with Omittable[T]", func(t *testing.T) {
		...
		typ, err := binder.FindType("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/autobinding/chat", "Message")
		require.NoError(t, err)
...
func createBinder(cfg Config) (*Binder, *ast.Schema) {
	cfg.Models = TypeMap{
		"Message": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/codegen/config/testdata/autobinding/chat.Message"},
		},
		"BarInput": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/codegen/config/testdata/autobinding/chat.Message"},
		},
		"String": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/graphql.String"},
		},
	}
...
func TestEnumBinding(t *testing.T) {
	...
	cf.Models = TypeMap{
		"Bar": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum.Bar"},
			EnumValues: map[string]EnumValue{
				"ONE": {Value: "github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum.BarOne"},
				"TWO": {Value: "github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum.BarTwo"},
			},
		},
		"Baz": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/graphql.Int"},
			EnumValues: map[string]EnumValue{
				"ONE": {Value: "github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum.BazOne"},
				"TWO": {Value: "github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum.BazTwo"},
			},
		},
		"String": TypeMapEntry{
			Model: []string{"github.com/OldBigBuddha/gqlgen/graphql.String"},
	...
	barType, err := binder.FindType("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum", "Bar")
	...
	barOne, err := binder.FindObject("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum", "BarOne")
	...
	barTwo, err := binder.FindObject("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum", "BarTwo")
	...
	bazType, err := binder.FindType("github.com/OldBigBuddha/gqlgen/graphql", "Int")
	...
	bazOne, err := binder.FindObject("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum", "BazOne")
	...
	bazTwo, err := binder.FindObject("github.com/OldBigBuddha/gqlgen/codegen/config/testdata/enum", "BazTwo")
