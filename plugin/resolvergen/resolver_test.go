...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/OldBigBuddha/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestLayoutSingleFileWithEnableRewrite(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/OldBigBuddha/gqlgen/plugin/resolvergen/testdata/singlefile_preserve/out")
}
...
func TestOmitTemplateComment(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/OldBigBuddha/gqlgen/plugin/resolvergen/testdata/omit_template_comment/out")
}
...
func TestResolver_Implementation(t *testing.T) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/OldBigBuddha/gqlgen/plugin/resolvergen/testdata/resolver_implementor/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/OldBigBuddha/gqlgen/plugin/resolvergen/"+dir+"/out")
}
